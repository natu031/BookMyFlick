...
for id, name, color in movies:
  ...
  <text x="150" y="200" fill="white" font-family="Arial" font-size="24" text-anchor="middle">{name}</text>
  <text x="150" y="240" fill="white" font-family="Arial" font-size="18" text-anchor="middle">BOOKMYFLICK</text>
</svg>'''
    with open(f'{folder}/{id}.svg', 'w') as f:
        f.write(svg)
